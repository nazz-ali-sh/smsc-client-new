...
export const buildingTypes = [
  { title: 'Below 11m\nTypically 3 floors or less', value: 'below_11m', image: '/svgs/development.svg' },
  { title: '11m - 18m\nTypically 4 to 5 floors ', value: '11m_18m', image: '/svgs/fourFloor.svg' },
  { title: 'Above 18m\nTypically 6 floors or more ', value: 'above_18m', image: '/svgs/sixFloor.svg' },
...
export const steps = [
  {
    ...
    description: 'Once you shortlist agents, they’ll automatically appear in the evaluation matrix below.'
  },
  {
  ...
  {
    title: 'Apply Weightings to Each Criterion',
    description: `Each criterion can be weighted from 0.5 to 1.5 in 0.25 increments to show its importance. `,
    newDescription: `For instance, if Communication is a top priority, give it a weighting of 1.5.
    The weighting is automatically applied to each score you enter.`,
  ...
  },
  {
    ...
    newDescription:
      'You can then calculate an average score for each criterion and enter that into the portal (only one final set of scores can be submitted per tender).'
  },
  {
    title: 'Save Your Matrix',
    description: 'Once you’ve completed all scores, click Save Matrix.',
    newDescription:
      'Your scores will then be locked and automatically included in your Final Report once you’ve selected your managing agent.'
  }
]
