...
interface SiteVisitsConfirmationModalProps {
  open: boolean
  onClose: () => void
}

const SiteVisitsConfirmationModal: React.FC<SiteVisitsConfirmationModalProps> = ({ open, onClose }) => {
    ...
    >
      ...
      <DialogContent sx={{ px: 3, py: 2 }}>
        <Typography variant='body2' sx={{ mb: 3, color: '#333', lineHeight: 1.5 }}>
          Your request for a site visit has been successfully submitted to the following agent:
        </Typography>
        ...
        <Box sx={{ mt: 3 }}>
          ...
          >
            Once the managing agents confirm their preferred time, they will update your portal with all attending staff
            from within their company
          </Typography>
          <Typography variant='body2' sx={{ color: 'customColors.textGray', lineHeight: 1.4, fontSize: '0.875rem' }}>
            Please remember to notify any other residents of your block whom you would like to attend the site visit.
          </Typography>
        </Box>
      </DialogContent>
    </Dialog>
...
export default SiteVisitsConfirmationModal
