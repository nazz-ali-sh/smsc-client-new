  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', maxWidth: '300px' }}>
        <Image src={'/svgs/rmcLogo.svg'} alt={'image'} width={100} height={100} className='' />
        ...
        <Box className='px-8 py-4  bg-[#F4F5F9]'>
          ...
          <Typography variant='body2' sx={{ marginBottom: '16px', textAlign: 'left', marginTop: 7, color: '#424242' }}>
